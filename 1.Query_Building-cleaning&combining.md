...
in
    ...
    let
    Source = Table.NestedJoin(#"Calendar - cleaned & appended", {"Listing_id"}, #"Listings - cleaned & appended", {"Id"}, "Listings - cleaned & appended", JoinKind.RightAnti),
    #"Expanded Listings - cleaned & appended" = Table.ExpandTableColumn(Source, "Listings - cleaned & appended", {"Id", "Name", "Host Id", "Host Name", "Host Since", "Host Is Superhost", "Host Total Listings Count", "Neighbourhood Cleansed", "Latitude", "Longitude", "Property Type", "Room Type", "Accommodates", "Price", "Review Scores Rating"}, {"Listings - cleaned & appended.Id", "Listings - cleaned & appended.Name", "Listings - cleaned & appended.Host Id", "Listings - cleaned & appended.Host Name", "Listings - cleaned & appended.Host Since", "Listings - cleaned & appended.Host Is Superhost", "Listings - cleaned & appended.Host Total Listings Count", "Listings - cleaned & appended.Neighbourhood Cleansed", "Listings - cleaned & appended.Latitude", "Listings - cleaned & appended.Longitude", "Listings - cleaned & appended.Property Type", "Listings - cleaned & appended.Room Type", "Listings - cleaned & appended.Accommodates", "Listings - cleaned & appended.Price", "Listings - cleaned & appended.Review Scores Rating"}),
